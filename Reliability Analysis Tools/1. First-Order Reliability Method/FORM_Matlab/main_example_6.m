%% FORM using HLRF algorithm and fmincon: Ex. 3 Ref. 3 - points outside of hypersphere
%{
---------------------------------------------------------------------------
Created by:
Felipe Uribe
...
dg    = @(u) [(((u(1)^2 + u(2)^2)^(1/2)/r)^m - 1)/(r*(((u(1)^2 + u(2)^2)^(1/2)/r)^m + 1)) - (2*u(1))/r^2 + (m*u(1)^2*((u(1)^2 + u(2)^2)^(1/2)/r)^(m - 1))/(r^2*(u(1)^2 + u(2)^2)^(1/2)*(((u(1)^2 + u(2)^2)^(1/2)/r)^m + 1)) - (m*u(1)^2*((u(1)^2 + u(2)^2)^(1/2)/r)^(m - 1)*(((u(1)^2 + u(2)^2)^(1/2)/r)^m - 1))/(r^2*(u(1)^2 + u(2)^2)^(1/2)*(((u(1)^2 + u(2)^2)^(1/2)/r)^m + 1)^2);
              (m*u(1)*u(2)*((u(1)^2 + u(2)^2)^(1/2)/r)^(m - 1))/(r^2*(u(1)^2 + u(2)^2)^(1/2)*(((u(1)^2 + u(2)^2)^(1/2)/r)^m + 1)) - (2*u(2))/r^2 - (m*u(1)*u(2)*((u(1)^2 + u(2)^2)^(1/2)/r)^(m - 1)*(((u(1)^2 + u(2)^2)^(1/2)/r)^m - 1))/(r^2*(u(1)^2 + u(2)^2)^(1/2)*(((u(1)^2 + u(2)^2)^(1/2)/r)^m + 1)^2) ];
